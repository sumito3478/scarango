#!/bin/bash
# Took from testing script from ashikawa-core. Thanks!
# https://github.com/triAGENS/ashikawa-core/blob/92a9546cf3ad0875ed13909d17395a19a1e2dc16/spec/setup/arangodb.sh
